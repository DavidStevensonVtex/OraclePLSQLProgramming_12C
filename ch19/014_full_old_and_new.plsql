...
-- You can use the REFERENCING clause to change the names of the pseudo-records within the database trigger;
-- this allows you to write code that is more self-documenting and application-specific.
